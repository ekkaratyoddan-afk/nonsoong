...
# 💡 เพิ่มเมนูข้าวหอมมะลิใหม่ และ ข้าวหอมมะลิเก่า แยกออกจากกันเรียบร้อยครับ ปรับราคาได้ตามต้องการ
MILL_BASE_PRICES = {
    "1. โรงสีบ้านดี": {
        "ข้าวหอมมะลิใหม่": 15800.0,
        "ข้าวหอมมะลิเก่า": 16200.0,
        "ข้าวเจ้าทั่วไป (นาปรังปี 69)": 8800.0,
        "ข้าวเหนียว กข6": 12100.0
    },
    "2. โรงสีนายบุญ": {
        "ข้าวหอมมะลิใหม่": 15650.0,
        "ข้าวหอมมะลิเก่า": 16000.0,
        "ข้าวเจ้าทั่วไป (นาปรังปี 69)": 8700.0,
        "ข้าวเหนียว กข6": 11950.0
    },
    "3. โรงเจริญผล": {
        "ข้าวหอมมะลิใหม่": 15700.0,
        "ข้าวหอมมะลิเก่า": 16100.0,
        "ข้าวเจ้าทั่วไป (นาปรังปี 69)": 8750.0,
        "ข้าวเหนียว กข6": 12000.0
    },
    "4. โรงสีธัญพืชผล": {
        "ข้าวหอมมะลิใหม่": 15750.0,
        "ข้าวหอมมะลิเก่า": 16150.0,
        "ข้าวเจ้าทั่วไป (นาปรังปี 69)": 8900.0,
        "ข้าวเหนียว กข6": 12050.0
    },
    "5. โรงสีตากบ": {
        "ข้าวหอมมะลิใหม่": 15500.0,
        "ข้าวหอมมะลิเก่า": 15900.0,
        "ข้าวเจ้าทั่วไป (นาปรังปี 69)": 8650.0,
        "ข้าวเหนียว กข6": 11800.0
    }
}

# --- รายการสายพันธุ์ข้าวสำหรับใช้ใน Dropdown เมนูเลือกข้าว ---
RICE_MENU_OPTIONS = ["ข้าวหอมมะลิใหม่", "ข้าวหอมมะลิเก่า", "ข้าวเจ้าทั่วไป (นาปรังปี 69)", "ข้าวเหนียว กข6"]
...
if user_role == "👨‍🌾 ฝั่งชาวนา":
    if menu == "🏠 หน้าแรก (Dashboard/ระบบหลัก)":
        ...
        if st.session_state.order_status == "ยังไม่มีรายการ":
            ...
            view_rice_type = st.radio("กดเลือกดูราคาเกณฑ์แต่ละชนิดข้าว:", RICE_MENU_OPTIONS)
            ...
            calc_rice_type = st.selectbox("เลือกประเภทข้าวที่จะขาย", RICE_MENU_OPTIONS)
            
            farmer_phone = st.text_input("📞 ใส่เบอร์โทรศัพท์ของคุณ (สำหรับคนขับรถติดต่อกลับ)", placeholder="เช่น 081-234-5678", max_chars=12)
            
            user_address = st.text_area("พิมพ์ที่อยู่แปลงนาอย่างละเอียด (ระบุบ้านเลขที่/หมู่บ้าน/ตำบล/จุดสังเกต)", 
            ...
            if st.button("🚛 ยืนยัน: เลือกโรงสีนี้และเรียกรถรับข้าว"):
                if not farmer_phone:
                    st.error("⚠️ โปรดกรอกเบอร์โทรศัพท์ของคุณก่อนกดปุ่มเรียกรถครับ")
            ...
            st.write(f"🌾 ชนิดข้าวที่เลือกขาย: **{st.session_state.order_detail['ประเภท']}**")
            st.write(f"📞 เบอร์ติดต่อของคุณในระบบ: **{st.session_state.order_detail['เบอร์ชาวนา']}**")
            ...
            if st.session_state.order_detail.get('เบอร์รถขนส่ง'):
                st.write(f"📱 เบอร์ติดต่อคนขับรถ: **{st.session_state.order_detail['เบอร์รถขนส่ง']}**")
...
# =========================================================================
    ...
    if st.session_state.order_status == "ยังไม่มีรายการ":
        st.info("💡 คำแนะนำการทดสอบ: ให้สลับไปที่บทบาท '👨‍🌾 ฝั่งชาวนา' เพื่อเลือกชนิดข้าวและโรงสีเข้ามาก่อนครับ")
