...
if user_role == "👨‍🌾 ฝั่งชาวนา":
    if menu == "🏠 หน้าแรก (Dashboard/ระบบหลัก)":
        ...
        if st.session_state.order_status == "ยังไม่มีรายการ":
            ...
            # ช่องกรอกเบอร์โทรศัพท์ของชาวนาที่เพิ่มเข้ามาใหม่
...
# =========================================================================
    ...
    if st.session_state.order_status == "ยังไม่มีรายการ":
        st.info("💡 คำแนะนำการทดสอบ: ให้สลับไปที่บทบาท '👨‍🌾 ฝั่งชาวนา' เพื่อกรอกข้อมูลเบอร์โทรศัพท์ เลือกโรงสี และปักหมุดนาข้าวเข้ามาก่อนครับ")
