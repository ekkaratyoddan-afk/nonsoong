...
if user_role == "👨‍🌾 ฝั่งชาวนา":
    if menu == "🏠 หน้าแรก (Dashboard/ระบบหลัก)":
        ...
        if st.session_state.order_status == "ยังไม่มีรายการ":
            ...
            # แสดงเรตราคาให้ชาวนาเปรียบเทียบก่อนตัดสินใจติ๊กเลือก
            ...
            # ส่วนให้ชาวนาติ๊กเลือกโรงสีตามที่ต้องการทันทีตั้งแตแรกตามโจทย์
            ...
            user_address = st.text_area("พิมพ์ที่อยู่แปลงนาอย่างละเอียด (ระบุบ้านเลขที่/หมู่บ้าน/จุดสังเกต)", 
            ...
            st.write("---")
            # แสดงกล่องสรุปเงินของโรงสีที่ชาวนาเลือกไว้ตั้งแต่แรก
            st.markdown(f"""
            <div class="calc-box">
...
# =========================================================================
    ...
    if st.session_state.order_status == "ยังไม่มีรายการ":
        ...
        # แจ้งคนขับรถให้ชัดเจนว่าชาวนาต้องการให้นำข้าวไปส่งที่โรงสีไหนตั้งแต่แรก
